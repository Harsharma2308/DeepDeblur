...
class MotionBlur():
    def __init__(self,train=True):
        ...
        self.Decoder = None
        self.VAE = None
        self.weights_path = '../model_weights/vae_blur_100.h5'
        self.image_size=28
        self.batch_size = 128
        self.epochs = 3
        self.train=train
    ...
    def GenerateModel(self):
        ...
        if(self.train):
            ...
            vae.fit(x_train,epochs=self.epochs,batch_size=self.batch_size)
...
if __name__ == "__main__":
    ...
    BLURGen.weights_path = '../model_weights/vae_blur_100.h5'
    BLURGen.LoadWeights()
    ...
    for i in range(n_samples):
        for j in range(n_samples):
            ...
            plt.axis("Off")
            k=k+1
    plt.savefig("../results/sampled_blur.png")